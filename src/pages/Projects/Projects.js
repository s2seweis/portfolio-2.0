...
function Projects({ scrollValue }) {
  ...
  console.log("line:500", current);
  const length = SliderData.length;
  console.log("line:600", length);
  console.log("line:700", SliderData);
  ...
  console.log("line:800", currentSlideData.title);
    ...
    <div className="Projects" id="Projects">
      <div className="projects__container"> 
        ...
        <div className='projects__title'>
          <h3 className={scrollValue ? "featured__project animation__fromLeft": "featured__project"} style={{margin:"auto"}} >{currentSlideData.title}</h3>
        </div>
