        ...
        <div
          ...
          <div 
            ...
            <div className="detail__container">
              <h1 className="about__greetings">Hi, I'm <span className="about__name">Sebastian</span> </h1>
            ...
            <a style={{margin:"20px auto"}} href={cv} download className='download__cv'>Download CV</a>
          </div>      
        </div>
      </div>
  )
