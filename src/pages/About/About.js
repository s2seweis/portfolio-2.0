...
import './About.css'
import lebenslauf from '../../assets/cv.pdf'
      ...
      <div className="About" id="About">
        <div
          ...
          <div 
            ...
            <a style={{margin:"20px auto", padding:"15px", width:"auto", fontSize:"15px"}} href={lebenslauf} download className='download__cv'>Download CV</a>
          </div>      
        </div>
      </div>
  )
